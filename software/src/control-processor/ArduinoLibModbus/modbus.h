...
MODBUS_API int modbus_set_slave(modbus_t *ctx, uint8_t slave);
MODBUS_API int modbus_set_error_recovery(modbus_t *ctx, modbus_error_recovery_mode error_recovery);
MODBUS_API int modbus_set_socket(modbus_t *ctx, int s);
MODBUS_API int modbus_get_socket(modbus_t *ctx);

MODBUS_API int modbus_get_response_timeout(modbus_t *ctx, uint16_t *ms);
MODBUS_API int modbus_set_response_timeout(modbus_t *ctx, uint16_t ms);

MODBUS_API int modbus_get_byte_timeout(modbus_t *ctx, uint16_t *ms);
MODBUS_API int modbus_set_byte_timeout(modbus_t *ctx, uint16_t ms);
